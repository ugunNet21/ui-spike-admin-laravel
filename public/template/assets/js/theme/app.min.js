...
if (isSidebar.length > 0) {
  var AdminSettings = {
    ...
    ManageDarkThemeLayout: function () {
      ...
      const currentTheme = savedTheme ? savedTheme : settings.Theme; // Gunakan tema yang disimpan atau tema default

      // Tentukan tema berdasarkan nilai currentTheme
      switch (currentTheme) {
        case "light":
        ...
        case "dark":
          ...
          break;
        default:
          // Tema default jika tidak ada yang disimpan
          setTheme("light", ["light-logo"], ["moon"], ["sun"]);
      }

      // Fungsi untuk mengatur tema
      function setTheme(theme, hideElements, showElements, hideElements2) {
        // Set atribut tema pada document
        document.documentElement.setAttribute("data-bs-theme", theme);

        // Ubah status checkbox sesuai tema yang dipilih
        document.getElementById(`${theme}-layout`).checked = true;

        // Sembunyikan dan tampilkan elemen sesuai tema
      ...
      // Menambahkan event listener untuk tombol yang mengganti tema
      ...
      if (darkModeButton && lightModeButton) {
        ...
        console.error("Tombol tema tidak ditemukan di DOM.");
      }
    },

    //****************************
    // Manage Color Theme Layout
    //****************************
